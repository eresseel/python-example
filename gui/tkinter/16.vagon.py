...
class Application(Tk):
    def __init__(self):
        Tk.__init__(self) # a szülo osztály constructora
    ...
    def kukucs(self):
        ...
        try:
            ...
            print("nem keszult el az objektum")
...
class Wagon:
    ...
    def perso(self, wind):
        ...
        circle(self.canvas_, xf+5, yf-3, 2) # jobbszemcircle(self.canvas_, xf, yf+5, 3) # száj
