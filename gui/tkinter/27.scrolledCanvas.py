...
class MainWind(Pmw.ScrolledCanvas):
    ...
    def __init__(self):
        ...
        # Kisméret GIF kép hozzáadása : ű
        self.img = PhotoImage(file ='Martin_p.gif')
    ...
    def anim(self):
        ...
        self.configure(label_text = 'Keress en %s %s' % (self.x, self.y))
        self.resizescrollregion()
