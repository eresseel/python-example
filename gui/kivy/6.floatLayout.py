...
os.environ["KIVY_HOME"] = os.getcwd() + "/6.configuracio"
...
class AlapWidget(FloatLayout):
    def __init__(self, **kwargs):
        ...
        gomb1 = Button(text="Gomb1", id="gomb1", size_hint=(0.2, 0.5), pos_hint={"right":1, "top":1})
        gomb1.bind(on_press=self.helloGomb)
        self.add_widget(gomb1)

        gomb2 = Button(text="Gomb2", id="gomb2", size_hint=(0.2, 0.5), pos_hint={"center_x":0.5, "center_y":0.5})
